<?php
if (!function_exists('ancnews_header_logo_section')) :
/**
 *  Header
 *
 * @since Anc-news
 *
 */
function ancnews_header_logo_section()
{
?>
<!-- Main Menu Area-->
      <?php $background_image = get_theme_support( 'custom-header', 'default-image' );
            ...
            <?php $remove_header_image_overlay = get_theme_mod('remove_header_image_overlay',false); ?>
              <div class="ancinner" <?php if($remove_header_image_overlay == false) { 
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="navbar-header">
                ...
                <?php do_action('ancnews_action_banner_advertisement'); ?>
            </div>
          </div>
        </div>
      </div>
...
add_action('ancnews_action_header_logo_section', 'ancnews_header_logo_section', 4);