...
<?php _e( 'Skip to content', 'news-zone' ); ?></a>
    <!--wrapper-->
    <div class="wrapper" id="custom-background-css">
                ...
                <nav class="navbar navbar-expand-lg navbar-wp">
                    ...
                    <div class="m-header align-items-center">
                        ...
                        <!-- navbar-toggle -->
                          ...
                          <button type="button" class="navbar-toggler" data-toggle="collapse" data-target=".navbar-collapse" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="<?php esc_attr_e('Toggle navigation','news-zone'); ?>">
        ...
        <section class="mg-fea-area">
            <div class="overlay">
              <div class="container">
                <div class="row my-4">
                    <?php do_action('newszone_action_front_page_main_section_1'); ?>
              </div>
              </div>
            </div>
        </section>
