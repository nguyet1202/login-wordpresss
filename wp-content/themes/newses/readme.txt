...
* Js Swiper.js
Author: iDangero.us
URL: https://idangero.us/swiper/
License: MIT

== WP Bootstrap navwalker ==
URI: https://github.com/twittem/wp-bootstrap-navwalker
Version: 2.0.4
Author: Edward McIntyre - @twittem License: GPL-2.0+
...
== Post Image ==
Image for theme screenshot, Copyright Sawyer Bengtson
License: Creative Commons CC0 license.
License URI: https://stocksnap.io/license
Source: https://stocksnap.io/photo/architecture-building-L5COL9F2GH

Image for theme screenshot, Copyright Mitch Rosen
License: Creative Commons CC0 license.
License URI: https://stocksnap.io/license
Source: https://stocksnap.io/photo/green-field-POIHJNTKDB

Image for theme screenshot, Copyright Helena Lopes
License: Creative Commons CC0 license.
License URI: https://stocksnap.io/license
Source: https://stocksnap.io/photo/city-architecture-FK7ZUQ3XM4

Image for theme screenshot, Copyright roya ann miller
License: Creative Commons CC0 license.
License URI: https://stocksnap.io/license
Source: https://stocksnap.io/photo/people-man-0NZR1ZMA6V

Image for theme screenshot, Copyright Afta Putta Gunawan
License: Creative Commons CC0 license.
License URI: https://stocksnap.io/license
Source: https://stocksnap.io/photo/restaurant-bar-KI4IDLRWIJ
...
Image for theme header, Copyright Marcin Jozwiak
License: Creative Commons CC0 license.
License URI: https://stocksnap.io/license
Source: https://stocksnap.io/photo/spain-vacation-MEOFXQL9UJ
...
License: Creative Commons CC0 license.
License URI: https://stocksnap.io/license
Source: https://stocksnap.io/photo/red-futuristic-EDDBMDHTVA
...
= Version 0.2
* Added Bootstrap navwalker licence.

= Version 0.3
* Change style & Remove codes.

= Version 0.4
* Fixed Bredcrumb and watch button issue.
...
= Version 0.8
* Added Wide & Box layout settings.
...
= Version 1.2.4
* Added Social share settings.

= Version 1.2.5
* Fixed post tag and styling issue.
...
= Version 1.2.9.1
* Added frontpage logo unlink support.

= Version 1.2.9.2
* Fixed Category issue.

= Version 1.2.9.3
* Fixed post pagination styling issue.
...
= Version 1.2.9.7
* Added settings for change footer widget text color.

= Version 1.2.9.8
* Fixed background color setting issue.

= Version 1.2.9.9
* Fixed styling issue.

= Version 1.2.9.10
* Fixed wp forms styling issue.

= Version 1.2.9.11
* Fixed Responsive styling issue.

= Version 1.2.9.12
* Added Telegram link on single post.

= Version 1.2.9.13
* Added single post navigation link.

= Version 1.2.9.14
* Fixed single and content image display issue.

= Version 1.2.9.15
* Added thumbnail support in Trrending post.
...
= Version 1.2.9.17
* Add grid layout setting

= Version 1.2.9.18
* Fixed date issue in single.php
...
= Version 1.2.9.21
* Fixed comment author style issue.

= Version 1.2.9.22
* Fixed style issue.

= Version 1.2.9.23
* Fixed comment not showing issue in page.php.
* Added edit link support on Full-width page template.

= Version 1.2.9.24
* Fixed nav-menu collapase issue

= Version 1.2.9.25
* Remove widget block editor support

= Version 1.2.9.26
* Fixed comment styling issue.
